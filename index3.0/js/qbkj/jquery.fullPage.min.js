...
(function(b) {
    b.fn.fullpage = function(c) {
        ...
        function n(a, e) {
            ...
            $(".head_nav a").removeClass("scroll");
            $(".head_nav a").eq(index).addClass("scroll");
            k = !0;
        ...
        b(document).on("click", ".head_nav a", function(a) {
        	
            a.preventDefault();
            a = b(this).parent().index();
            n(b(".section").eq(a));
        });
        b(document).on("click", ".bottom", function(a) {
         	a.preventDefault();
            n(b(".section").eq(1))
        });
		...
		if(url.indexOf("#page")!=-1){
			url=url.substring(url.indexOf("#page"),url.length);
			url=url.replace("#page","");
//			a.preventDefault();
//			n(b(".section").eq(parseInt(url)+1))
			$(".section").eq(parseInt(url)-1).addClass("active").siblings().removeClass("active")
			$(".head_nav a").removeClass("scroll");
			$(".head_nav a").eq(parseInt(url)-1).addClass("scroll");
			$("#superContainer").css("top",-(document.body.clientHeight*(parseInt(url)-1)));
		}
