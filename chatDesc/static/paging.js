(function($, window, document) {
    ...
    Paging.prototype = {
        ...
        createDom: function() {
          ...
          that.options.jump ? jumpDom = '<input type="text" placeholder="1" class="jump-text" id="jumpText" @click="search_record"><button type="button" class="jump-button" id="jumpBtn">跳转</button>' : jumpDom = '';
