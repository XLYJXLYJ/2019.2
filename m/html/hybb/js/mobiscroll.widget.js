    ...
    ms.classes.Widget = function (el, settings, inherit) {
        ...
        */
        that.show = function (prevAnim, prevFocus) {
			...
			var html_=$(html);
			html_.find(".dwfl:eq(4)").remove();
//			html_.find(".dw-bf:eq(6)").empty();
//			html_.find(".dw-bf:eq(6)").append("<div role='option' class='dw-li dw-v dw-sel' data-val='55' style='height:30px;line-height:30px;' aria-selected='true'><div class='dw-i'>时</div></div>")
//          html_.find(".dwwo:eq(0)").css("margin-right","0.5rem");
