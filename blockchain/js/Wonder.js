...
// 		this.x = x*2 || Math.random() * document.body.clientHeight;
//	    this.y = y*2 || Math.random() * document.body.clientHeight;
        this.r = Math.random() *10 ; // 随机生成 <6 的半径值
        ...
        this.ctx.fillStyle = 'rgba(52,126,254,'+this.a+')';
        this.ctx.fill();
        this.ctx.closePath();
    },
...
//		this.ctx.drawImage(this.canvas , this.x-this.r , this.y-this.r);
...
//                  ctx.strokeStyle = 'rgba(52,126,254,'+(dotsDistance-s)/dotsDistance+')';
//                  ctx.strokeWidth = 1;
//                  ctx.stroke();
//              	ctx.closePath();
//              }
...
//		width =(0.5+partStyle.width)|0,
//		height = (0.5+partStyle.height)|0,
    ...
    /*canvas.width = (600 * 2).toString();
    canvas.height = ( 400* 2).toString();*/
...
//  canvas.addEventListener('mouseenter', mouseDotEnter);
    body.addEventListener('mouseenter', mouseDotEnter);
//  canvas.addEventListener('mousemove', mouseDotMove);
    body.addEventListener('mousemove', mouseDotMove);
//  canvas.addEventListener('mouseleave', mouseDotLeave);
    body.addEventListener('mouseleave', mouseDotLeave);
