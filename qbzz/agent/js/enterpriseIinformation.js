...
//			}
	...
	$(".used1 a").click(function(){
		...
		var id=$(this).data("id");
		var zz=0;
		$(".fix-people1 ul li").each(function(){
	...
	$(".used2 a").click(function(){
		...
		var id=$(this).data("id");
		var zz=0;
		$(".fix-people2 ul li").each(function(){
			var ider=$(this).data("id");
			if(ider==id){
				zz=1;
				$(this).find("input").attr("checked",true);
...
//		});
    ...
    $(".gb label").eq(0).click(function(){
    	$(".methods label").eq(0).show().find("input").attr("checked",true);
    	$(".deal_content").eq(0).show().siblings(".deal_content").hide();
	});
	$(".gb label").eq(1).click(function(){
		$(".methods label").eq(0).hide().siblings("label").find("input").attr("checked",true);
		$(".deal_content").eq(1).show().siblings(".deal_content").hide();
		
	});
	
	
    $(".methods label").click(function(){
    	var index = $(this).index();
    	$(".deal_content").eq(index).show().siblings(".deal_content").hide();
	});
